...
main()
{
   ...
   Copy ${repoDir}/zm-db-conf/src/db/migration/migrate20190508-ZimbraChat.pl                        ${repoDir}/zm-build/${currentPackage}/opt/zimbra/libexec/scripts/migrate20190508-ZimbraChat.pl
